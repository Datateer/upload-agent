...
from datateer_upload_agent.main import cli
...
@patch.dict('datateer_upload_agent.main.config', constants.SAMPLE_CONFIG, clear=True)
...
@patch.dict('datateer_upload_agent.main.config', {'client-code': 'TEST-CLIENT-CODE'}, clear=True)
@patch('datateer_upload_agent.main.load_config')
...
@patch.dict('datateer_upload_agent.main.config', {'client-code': 'MY-TEST-CLIENT-CODE'})
@patch('datateer_upload_agent.main.load_config')
